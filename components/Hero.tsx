...
const Hero = () => {
    return (
        <div className="pb-20 pt-36">
            ...
            dark:bg-grid-white/[0.03] bg-grid-black/[0.03] absolute top-0 left-0 flex
            ...
            <div className="flex justify-center relative  my-20 z-10">
                ...
                items-center justify-center relative">
                    ...
                    <TextGenerateEffect
                        ...
                        words="From Ideas into experiences that last"
                    />
                    <p className="text-center md:tracking-wider mb-4 text-sm
                    md:text-lg lg:text-2xl">
                        Hey there, this is Zacharia, I am a Full-stack developer based in Kenya
                    </p>
                    <a href="#about">
                        <MagicButton
                            title="Here is my body of work "
